	...
	<form action="TransactionController?operation=depositMoney" method="post">
		...
		<table align="center" style="font-size:20px;font-style:bold" class="rounded">
			...
			<tr>
				...
				<td><input type="number" name="depositAmt" oninput="this.value = Math.abs(this.value)" required></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><input type="submit" class="btn btn-dark" value="Submit"></td>
				<h3 style="color:red">${depositError}</h3>
			</tr>
