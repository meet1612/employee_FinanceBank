                ...
                <form id="msform">
                    ...
                    <fieldset name="fs1">
                        ...
                        <input type="hidden" name="loan_id" id="loan_id" value=<%= l.getLoan_id() %>>
                        	 ...
                        	 <input type='button' name='reject' id='reject1' onclick='onclickReject()' class='action-button' value='Reject' />
                             <input type='button' name='next' id='status1' onclick='onclickStatus1()'  class='next action-button' value='Next' />
                    ...
                    <fieldset name="fs2">
                        <div class="form-card">
                            <div class="row">
                                <div class="col-7">
                                    <h2 class="fs-title">Documentation Check:</h2>
                                </div>
                                <div class="col-5">
                            ...
                            <h5>Waiting for client's acknowledgement about the documents verification.</h5>
                            
                        </div>
                        <input type='button' name='reject' id='reject1' onclick='onclickReject()' class='action-button' value='Reject' />
                         <input type="button" name="next" id="status2" onclick="onclickStatus2()" class="next action-button" value="Next" /> 
                    ...
                    <fieldset name="fs3">
                        <div class="form-card">
                            ...
                            <h6>Money will be send to the person's bank account after approval and before that please verify all details given above.</h6>
                            
                            
                        </div> 
                        <input type='button' name='reject' id='reject1' onclick='onclickReject()' class='action-button' value='Reject' />
                        <input type="button" id="status3" name="next" onclick="onclickStatus3()" class="next action-button" value="Approve" /> 
                    </fieldset>
                    <fieldset name="fs4">
                        <div class="form-card">
                            <div class="row">
                            ...
                            <h4 class="purple-text text-center"><strong>SUCCESS !</strong></h4>
                            <div class="row justify-content-center">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-7 text-center">
                                    <h5 class="purple-text text-center">Loan is approved successfully.!</h5>
                                </div>
                            </div>
                        </div>
                    </fieldset>
